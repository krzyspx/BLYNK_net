...
char auth[] = "db69aa13a9b84bcdb24947828183abae";
...
WidgetLED led1(V4); // led w aplikacji wskazujący na połacenie mikroprocesor - aplikacja
...
void blynksetup() //nie blokująca procedura połączenia z BLYNK
{
  ...
  Blynk.setProperty(V3, "color", _MAGENTA);
